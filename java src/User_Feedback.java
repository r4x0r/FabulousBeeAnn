...
public class User_Feedback extends HttpServlet {  // JDK 6 and above only
	int breakline = 41;
	int offset = 28;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (exists) {
				...
				reader = new BufferedReader(new FileReader(filepathString + "user_feedback_template.html"));
				writer = new PrintWriter(filepathString + "user_feedback.html");
				...
				writer.flush();
				response.sendRedirect("http://" + Global.getIPadd() + ":9999/FabulousBeeAnn" + "/user_feedback.html");
